    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900"
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out"
            ...
            <div class="flex items-center justify-between h-16 px-6 border-b dark:border-gray-700">
                ...
                <button @click="$store.sidebar.toggle()" 
                        class="block p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 transition-colors duration-200">
        ...
        <div x-show="!$store.sidebar.open" 
            ...
            <div class="flex flex-col items-center py-4">
                <button @click="$store.sidebar.toggle()" 
                        class="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
